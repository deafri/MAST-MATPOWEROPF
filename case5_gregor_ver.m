...
mpc.branch = [
	1	2	8.4e-05	8.4e-05	0	    Inf	Inf	Inf	1	0	1	-360 360;
	1	3	8.4e-05	8.4e-05	0	    Inf	Inf	Inf	1	0	1	-360 360;
	2	3	8.4e-05	8.4e-05	0	    Inf	Inf	Inf	1	0	1	-360 360;
	2	4	8.4e-05	8.4e-05	0	    Inf	Inf	Inf	1	0	1	-360 360;
	2	5	8.4e-05	8.4e-05	0	    Inf	Inf	Inf	1	0	1	-360 360;
	3	4	8.4e-05	8.4e-05	0	    Inf	Inf	Inf	1	0	1	-360 360;
	4	5	8.4e-05	8.4e-05	0	    Inf	Inf	Inf	1	0	1	-360 360;
];

mpc.branch(:,4) = 10*mpc.branch(:,4);
mpc.branch(:,5) = mpc.branch(:,3);
